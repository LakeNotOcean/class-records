...
export class Migration1717494715595 implements MigrationInterface {
	name = 'Migration1717494715595';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`CREATE VIEW "class"."lessons_view" 
        AS select l.id as lessonId, l."date" as lessonDate, l.status as lessonStatus, l.title as lessonTitle, 
    ...
    left join (
        ...
        from "class".lesson_students ls2 
